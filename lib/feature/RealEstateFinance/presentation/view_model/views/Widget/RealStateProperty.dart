...
import 'ShowHome.dart';
import 'package:url_launcher/url_launcher.dart';
import 'package:share_plus/share_plus.dart';
import 'package:flutter/services.dart' show rootBundle;
import 'package:path_provider/path_provider.dart';
class RealStateProperty extends StatefulWidget {
  final String name;
  final String type;
  ...
  @override
  _RealStatePropertyState createState() => _RealStatePropertyState();
}
class _RealStatePropertyState extends State<RealStateProperty> {
  @override
  ...
  Future<void> shareContentWithImage() async {
    ...
    try {
     ...
     ${widget.beds} beds ${widget.baths} baths ${widget.size} M \n
     ${widget.price} EGP
    ''';
                          ...
                          return GestureDetector(
                            onTap: () {
                              Navigator.of(context).push(
                                MaterialPageRoute(
                                  builder: (context) => FullScreenRealState(
                                    name: widget.name,
