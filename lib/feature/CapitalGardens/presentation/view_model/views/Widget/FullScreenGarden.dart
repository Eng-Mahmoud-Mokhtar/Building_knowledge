...
class FullScreenGarden extends StatefulWidget {
  final List<String> imageUrls;
  final int initialIndex;
  final String name;
  const FullScreenGarden({
    Key? key,
  ...
  @override
  _FullScreenGardenState createState() => _FullScreenGardenState();
}

class _FullScreenGardenState extends State<FullScreenGarden> {
